...
![Profile Views](https://komarev.com/ghpvc/?username=dwi-lutfi&color=blueviolet&style=flat-square&label=Profile+Views)
...
```mermaid
graph LR
    A[Learning] --> B[LLMs & LangChain]
    A --> C[Advanced Flutter]
    A --> D[Microservices]
    B --> E[Building AI Apps]
    C --> E
    D --> E
    E --> F[Production Ready Solutions]
```
